...
public final class MPush {
    ...
    HttpClientListener mHttpClientListener = null;
    ...
    public void startPush() {
        if (hasInit()) {
            Log.i("jingyi", "startPush...");
            ctx.startService(new Intent(ctx, MPushService.class));
            ctx.bindService(new Intent(ctx, MPushService.class),
    ...
    public void setHttpClientListener(HttpClientListener httpClientListener) {
        this.mHttpClientListener = httpClientListener;
        if (mPushService != null) {
            mPushService.setHttpClientListener(mHttpClientListener);
        }
    }
    ...
    private ServiceConnection mServiceConnection =  new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            mPushService = null;
            mPushService.setHttpClientListener(null);
        }
